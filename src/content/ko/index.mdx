...
title: DM Note 문서
sidebarTitle: 소개
description: DM Note 키뷰어와 키보드 오버레이의 설치, OBS 연결 및 커스터마이징 안내
---

# DM Note 문서 

**DM Note**는 DJMAX RESPECT V를 비롯한 리듬게임의 키 입력을 화면에 보여주는 키뷰어입니다.
키 오버레이를 게임 화면 위에 배치하거나 스트리밍·플레이 영상에 함께 표시할 수 있습니다.

[OBS 설정 안내](/docs/guide/tips#obs-설정)에서 키보드 오버레이를 방송에 추가하는 방법을 확인하고,
[커스텀 CSS 안내](/docs/custom-css)에서 모양을 바꾸는 방법을 살펴볼 수 있습니다.
